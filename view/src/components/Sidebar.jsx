...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {
      path: "/prediction/disease-chat",
      name: "Disease Chatbot",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  ...
  return (
    <div className="fixed left-0 top-0 min-h-screen w-64 bg-white shadow-lg z-50">
